package com.piseth.java.school.webflux_playgroud.sec004;
...
@SpringBootTest(properties = "sec=sec004")
public class CustomerServiceTest {
	...
	void invalidInput() {
		//name
		var missingNameDto = new CustomerDTO();
		missingNameDto.setEmail("ethan@gmail.com");
		webTestClient.post()
			.uri("/customers")
		...
		//email
		var missingValidEmailDto = new CustomerDTO();
		missingValidEmailDto.setName("Dara");
		webTestClient.post()
			.uri("/customers")
			.bodyValue(missingValidEmailDto)
			.exchange()
			.expectStatus().is4xxClientError()
			.expectBody()
		...
		//email missing @
		var missingValidEmail2Dto = new CustomerDTO();
		missingValidEmail2Dto.setName("Ethan");
		missingValidEmail2Dto.setEmail("ethangmail.com");
		webTestClient.put()
			.uri("/customers/10")
			.bodyValue(missingValidEmail2Dto)
			.exchange()
			.expectStatus().is4xxClientError()
			.expectBody()
			.jsonPath("$.detail").isEqualTo("Valid email is required");
